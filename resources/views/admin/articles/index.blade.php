                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            ...
                            <small class="text-muted d-block">
                                <i class="far fa-calendar-alt mr-1"></i> Terbit: {{ $article->created_at->format('d M Y H:i') }} WIB
                            </small>
                            <small class="text-secondary d-block">
                                <i class="fas fa-link mr-1"></i> {{ $article->slug }}
                            </small>
                        </td>
                        <td class="align-middle text-center">
                            <span class="badge badge-info shadow-sm px-2 py-1 mb-2 d-inline-block">
                            ...
                            <div class="d-block">
                                ...
                                @empty
                                    <span class="text-muted small d-block">Tidak ada tag</span>
                                @endforelse
                            </div>
                        </td>
                        <td class="align-middle">
                            <span class="font-weight-bold text-dark">
                                <i class="fas fa-user-circle mr-1"></i> {{ $article->user->name }}
                            </span>
                        ...
                        <td class="text-center align-middle">
                            <a href="{{ route('articles.edit', $article->id) }}" 
                               class="btn btn-warning btn-sm shadow-sm mb-1 d-block mx-auto" 
                               style="width: 80px;">
                            ...
                            <form action="{{ route('articles.destroy', $article->id) }}" method="POST" class="d-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm shadow-sm mx-auto" 
                                        style="width: 80px;" 
